...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'fos_message.driver' => 'getFosMessage_DriverService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('aNPrj49Fag', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('z9gvTfxbW+', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tev08nEX7N', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Nobtc8Pk-k', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5zAEGzcqev', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('8cf58401d83a68399e5cdae44ba464327a0452f4')) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), '!FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/IL/CoreBundle/Resources/views'), 'ILCore');
        $instance->addPath(($this->targetDirs[3].'/src/IL/CoreBundle/Resources/views'), '!ILCore');
        $instance->addPath(($this->targetDirs[3].'/src/IL/BankBundle/Resources/views'), 'ILBank');
        $instance->addPath(($this->targetDirs[3].'/src/IL/BankBundle/Resources/views'), '!ILBank');
        $instance->addPath(($this->targetDirs[3].'/src/IL/UserBundle/Resources/views'), 'ILUser');
        $instance->addPath(($this->targetDirs[3].'/src/IL/UserBundle/Resources/views'), '!ILUser');
        $instance->addPath(($this->targetDirs[3].'/src/IL/BackBundle/Resources/views'), 'ILBack');
        $instance->addPath(($this->targetDirs[3].'/src/IL/BackBundle/Resources/views'), '!ILBack');
        $instance->addPath(($this->targetDirs[3].'/src/IL/ApiBundle/Resources/views'), 'ILApi');
        $instance->addPath(($this->targetDirs[3].'/src/IL/ApiBundle/Resources/views'), '!ILApi');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('8cf58401d83a68399e5cdae44ba464327a0452f4');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'ILCoreBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/IL/CoreBundle'),
                    'namespace' => 'IL\\CoreBundle',
                ),
                'ILBankBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/IL/BankBundle'),
                    'namespace' => 'IL\\BankBundle',
                ),
                'ILUserBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/IL/UserBundle'),
                    'namespace' => 'IL\\UserBundle',
                ),
                'ILBackBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/IL/BackBundle'),
                    'namespace' => 'IL\\BackBundle',
                ),
                'ILApiBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/IL/ApiBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ILCoreBundle' => 'IL\\CoreBundle\\ILCoreBundle',
                'ILBankBundle' => 'IL\\BankBundle\\ILBankBundle',
                'ILUserBundle' => 'IL\\UserBundle\\ILUserBundle',
                'ILBackBundle' => 'IL\\BackBundle\\ILBackBundle',
                'ILApiBundle' => 'IL\\ApiBundle\\ILApiBundle',
            ...
            'database_port' => 8889,
            'database_name' => 'ilafia',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'sidibesekouassane@gmail.com',
            'mailer_password' => 'sorofing',
            'secret' => '8cf58401d83a68399e5cdae44ba464327a0452f4',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '8cf58401d83a68399e5cdae44ba464327a0452f4',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'sidibesekouassane@gmail.com',
            ...
            'fos_user.model.user.class' => 'IL\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'sidibesekouassane@gmail.com' => 'ILAFIA',
            ),
