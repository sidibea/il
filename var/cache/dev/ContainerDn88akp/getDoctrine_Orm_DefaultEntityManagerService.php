...
$b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/IL/CoreBundle/Entity'), 1 => ($this->targetDirs[3].'/src/IL/UserBundle/Entity')));

$c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
$c->addDriver($b, 'IL\\CoreBundle\\Entity');
$c->addDriver($b, 'IL\\UserBundle\\Entity');
...
$d->setEntityNamespaces(array('ILCoreBundle' => 'IL\\CoreBundle\\Entity', 'ILUserBundle' => 'IL\\UserBundle\\Entity'));
