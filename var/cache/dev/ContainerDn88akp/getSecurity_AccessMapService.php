...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), array(0 => 'ROLE_BACK_OFFICE', 1 => 'ROLE_FRONT_OFFICE'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/bank'), array(0 => 'ROLE_FRONT_OFFICE'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/back'), array(0 => 'ROLE_BACK_OFFICE'), NULL);
