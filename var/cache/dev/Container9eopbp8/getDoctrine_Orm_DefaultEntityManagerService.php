...
$a = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'/src/IL/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/IL/CoreBundle/Entity')));

$b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
$b->addDriver($a, 'IL\\UserBundle\\Entity');
$b->addDriver($a, 'IL\\CoreBundle\\Entity');
...
$c->setEntityNamespaces(array('ILUserBundle' => 'IL\\UserBundle\\Entity', 'ILCoreBundle' => 'IL\\CoreBundle\\Entity'));
