...
class __TwigTemplate_68bbdc10f519450ee8e38dd5fd99a397e429631fd37412c739c75823409e2f9c extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        // line 16
        echo twig_escape_filter($this->env, twig_length_filter($this->env, ($context["user"] ?? $this->getContext($context, "user"))), "html", null, true);
        echo "</div>
                ...
                <div class=\"col-sm-6 col-lg-3\">
                    <div class=\"card text-white bg-info\">
                        <div class=\"card-body pb-0\">
                            ...
                            <div class=\"text-value\">";
        // line 31
        echo twig_escape_filter($this->env, $this->getAttribute(($context["transaction"] ?? $this->getContext($context, "transaction")), "nbre", array()), "html", null, true);
        echo "</div>
...
";
    ...
    {
        return array (  140 => 84,  102 => 49,  81 => 31,  63 => 16,  49 => 4,  40 => 3,  11 => 1,);
    }
                ...
                <div class=\"col-sm-6 col-lg-3\">
                    <div class=\"card text-white bg-primary\">
                        <div class=\"card-body pb-0\">
                            ...
                            <div class=\"text-value\">{{ user |length }}</div>
                            <div>Nombre d'utilisateurs</div>
                        </div>
                        <div class=\"chart-wrapper mt-3 mx-3\" style=\"height:70px;\">
                            <canvas id=\"card-chart1\" class=\"chart\" height=\"70\"></canvas>
                ...
                <div class=\"col-sm-6 col-lg-3\">
                    <div class=\"card text-white bg-info\">
                        <div class=\"card-body pb-0\">
                            ...
                            <div class=\"text-value\">{{ transaction.nbre }}</div>
                            <div>Nombre de transactions</div>
                        </div>
                        <div class=\"chart-wrapper mt-3 mx-3\" style=\"height:70px;\">
                            <canvas id=\"card-chart2\" class=\"chart\" height=\"70\"></canvas>
...
{% endblock %}", "ILBankBundle:Homepage:index.html.twig", "/Applications/MAMP/htdocs/il/src/IL/BankBundle/Resources/views/Homepage/index.html.twig");
    }
}
