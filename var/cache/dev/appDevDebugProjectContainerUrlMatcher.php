    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/back')) {
            ...
            if ('/back' === $trimmedPathinfo) {
                ...
                if ('/' === substr($pathinfo, -1)) {
                    ...
                    goto not_il_back_homepage;
                } else {
                    return array_replace($ret, $this->redirect($rawPathinfo.'/', 'il_back_homepage'));
                }

                return $ret;
            }
            not_il_back_homepage:

            // il_back_add_user
            if ('/back/add-user' === $pathinfo) {
                return array (  '_controller' => 'IL\\BackBundle\\Controller\\BackController::addAction',  '_route' => 'il_back_add_user',);
            }
        ...
        elseif (0 === strpos($pathinfo, '/bank')) {
            ...
            if ('/bank' === $trimmedPathinfo) {
                $ret = array (  '_controller' => 'IL\\BankBundle\\Controller\\BankController::dashboardAction',  '_route' => 'il_bank_homepage',);
                if ('/' === substr($pathinfo, -1)) {
                    // no-op
                } elseif ('GET' !== $canonicalMethod) {
            ...
            // il_bank_souscription
            if ('/bank/new-souscription' === $pathinfo) {
                return array (  '_controller' => 'IL\\BankBundle\\Controller\\BankController::souscriptionAction',  '_route' => 'il_bank_souscription',);
            }

            // il_bank_souscription_edit
            if (0 === strpos($pathinfo, '/bank/edit-souscription') && preg_match('#^/bank/edit\\-souscription/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'il_bank_souscription_edit')), array (  '_controller' => 'IL\\BankBundle\\Controller\\BankController::sousEditAction',));
            }

            if (0 === strpos($pathinfo, '/bank/souscription-lists')) {
                // il_bank_souscription_list
                if ('/bank/souscription-lists' === $pathinfo) {
                    return array (  '_controller' => 'IL\\BankBundle\\Controller\\BankController::listAction',  '_route' => 'il_bank_souscription_list',);
                }

                // il_bank_souscription_list_banque
                if ('/bank/souscription-lists-banque' === $pathinfo) {
                    return array (  '_controller' => 'IL\\BankBundle\\Controller\\BankController::banqueListAction',  '_route' => 'il_bank_souscription_list_banque',);
                }
        ...
        // il_core_homepage
        if ('' === $trimmedPathinfo) {
            $ret = array (  '_controller' => 'IL\\BackBundle\\Controller\\BackController::indexAction',  '_route' => 'il_core_homepage',);
            if ('/' === substr($pathinfo, -1)) {
                // no-op
            } elseif ('GET' !== $canonicalMethod) {
                goto not_il_core_homepage;
            } else {
                return array_replace($ret, $this->redirect($rawPathinfo.'/', 'il_core_homepage'));
            }

            return $ret;
        }
        not_il_core_homepage:
